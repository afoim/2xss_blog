...
draft: false
tags: []
coverImage: https://raw-posts.2x.nz/img/emdash-index.png
---
## 这是什么？
...
1. 令人难绷的文章封面图![](https://raw-posts.2x.nz/img/emdash-index-2.png)
2. 评论只有 提交 → 审核 → 展示。高级功能要自己写代码![](https://raw-posts.2x.nz/img/emdash-index-3.png)
3. 最大亮点就是边缘化，但是部署到CF要钱![](https://raw-posts.2x.nz/img/emdash-index-5.png)
