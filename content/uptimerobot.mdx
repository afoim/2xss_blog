...
draft: false
coverImage: https://raw-posts.2x.nz/img/uptimerobot-2025-09-04-04-10-47-image.webp
---
## 正式开始
...
![](https://raw-posts.2x.nz/img/uptimerobot-2025-09-04-04-10-47-image.webp)

建议设置为自动添加，这样就无需手动将监控一个个添加到页面，你的账户下每创建一个新的监控都会实时同步到你的展示页上

配置完毕后， 在 `Public status page, hosted on` 后就是你的监控展示页面

![](https://raw-posts.2x.nz/img/uptimerobot-2025-09-04-04-13-19-image.webp)

![](https://raw-posts.2x.nz/img/uptimerobot-2025-09-04-04-15-31-image.webp)
