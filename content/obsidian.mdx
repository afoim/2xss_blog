...
draft: false
coverImage: https://raw-posts.2x.nz/img/obsidian-obsidian.webp
---
...
![](https://raw-posts.2x.nz/img/obsidian-obsidian-1.webp)
然后点击 **管理仓库** ，然后根据你所需要的情况进行选择
![](https://raw-posts.2x.nz/img/obsidian-obsidian-2.webp)
...
点击 **设置** 
![](https://raw-posts.2x.nz/img/obsidian-obsidian-3.webp)
如图配置，这样我们就解决了第一个问题
![](https://raw-posts.2x.nz/img/obsidian-obsidian-4.webp)
...
![](https://raw-posts.2x.nz/img/obsidian-obsidian-5.webp)
接下来，尝试使用任一截图工具，如 **QQ截图** ，截图后使用 **Ctrl+V** 粘贴进文章，你应当能看到类似这样的图片链接了
```bash
![](https://raw-posts.2x.nz/img/obsidian-obsidian.webp)
```
## 黑曜石如何强大？
`published` 字段可以通过点点点实现
![](https://raw-posts.2x.nz/img/obsidian-obsidian-6.webp)
通用字段可以直接填充曾经写过的
![](https://raw-posts.2x.nz/img/obsidian-obsidian-7.webp)
`tags` 字段只需要你专注于标签，无需再手动管理格式
![](https://raw-posts.2x.nz/img/obsidian-obsidian-8.webp)
布尔字段通过勾选来处理 `true` 和 `false`
![](https://raw-posts.2x.nz/img/obsidian-obsidian-9.webp)
