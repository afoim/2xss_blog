...
draft: false
tags: []
coverImage: https://raw-posts.2x.nz/img/concurrently-concurrently.png
---
## 引言
...
![](https://raw-posts.2x.nz/img/concurrently-concurrently-1.png)

后端是一坨 Typescript

![](https://raw-posts.2x.nz/img/concurrently-concurrently-2.png)

而前端要用 Vite 来 Dev

![](https://raw-posts.2x.nz/img/concurrently-concurrently-3.png)

那么后端还要使用 Wrangler 来 Dev

![](https://raw-posts.2x.nz/img/concurrently-concurrently-4.png)
...
![](https://raw-posts.2x.nz/img/concurrently-concurrently-5.png)

![](https://raw-posts.2x.nz/img/concurrently-concurrently-6.png)
