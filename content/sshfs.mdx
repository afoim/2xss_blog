...
draft: false
coverImage: https://raw-posts.2x.nz/img/sshfs-Linux-win.png
---
...
![](https://raw-posts.2x.nz/img/sshfs-sshfs.png)

![](https://raw-posts.2x.nz/img/sshfs-sshfs-1.png)

同时，我们也可以使用任何软件来直接打开Linux上的文件来远程开发

![](https://raw-posts.2x.nz/img/sshfs-sshfs-2.png)
...
![](https://raw-posts.2x.nz/img/sshfs-sshfs-4.png)
