...
draft: false
tags: []
coverImage: https://raw-posts.2x.nz/img/ai-agent-ai-agent.png
---
## 引言
...
![](https://raw-posts.2x.nz/img/ai-agent-ai-agent-1.png)
...
![](https://raw-posts.2x.nz/img/ai-agent-ai-agent-2.png)
...
![](https://raw-posts.2x.nz/img/ai-agent-Image_1772724238045_770.png)
...
![](https://raw-posts.2x.nz/img/ai-agent-Image_1772724294856_373.png)
...
![](https://raw-posts.2x.nz/img/ai-agent-ai-agent-3.png)
...
![](https://raw-posts.2x.nz/img/ai-agent-ai-agent-4.png)

#### [ZCF](https://github.com/UfoMiao/zcf)

这个工具可以自动帮你安装 Agent，并一键部署一些主流 MCP，还能设置模型系统提示词预设，并提供基础工作流。

![](https://raw-posts.2x.nz/img/ai-agent-ai-agent-5.png)
...
![](https://raw-posts.2x.nz/img/ai-agent-ai-agent-6.png)
...
![](https://raw-posts.2x.nz/img/ai-agent-ai-agent-7.png)

接下来你就可以让它做你要做的事：删文件、写文章、修 Bug，甚至从零搭建项目。

![](https://raw-posts.2x.nz/img/ai-agent-ai-agent-8.png)

![](https://raw-posts.2x.nz/img/ai-agent-ai-agent-9.png)
