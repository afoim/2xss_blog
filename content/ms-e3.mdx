...
draft: false
coverImage: https://raw-posts.2x.nz/img/ms-e3-ms-e3.webp
---
> [!CAUTION]
> 已封车
## 参考文献
...
点击 账单 - 你的产品
![](https://raw-posts.2x.nz/img/ms-e3-ms-e3-1.webp)

点分配许可证
![](https://raw-posts.2x.nz/img/ms-e3-ms-e3-2.webp)

分配给你主账户
![](https://raw-posts.2x.nz/img/ms-e3-ms-e3-3.webp)
...
![](https://raw-posts.2x.nz/img/ms-e3-ms-e3-4.webp)

接下来我们来扩容

在管理中心点击全部显示
![](https://raw-posts.2x.nz/img/ms-e3-ms-e3-5.webp)

选择 SharePoint
![](https://raw-posts.2x.nz/img/ms-e3-ms-e3-6.webp)

更改 设置 - OneDrive - 存储限制 为 5120 GB
![](https://raw-posts.2x.nz/img/ms-e3-ms-e3-7.webp)

此时等等你的账号就会同步扩容了，如果等不及我们可以来手动强制扩容

回到 管理中心 选择 用户-活跃用户-管理角色-OneDrive，强制扩容
![](https://raw-posts.2x.nz/img/ms-e3-ms-e3-8.webp)

![](https://raw-posts.2x.nz/img/ms-e3-ms-e3-9.webp)

用刚才讲过的方法进入OneDrive，成功扩容
![](https://raw-posts.2x.nz/img/ms-e3-ms-e3-10.webp)

最后，注意一下，及时前往 [My Sign-Ins | Security Info | Microsoft.com](https://mysignins.microsoft.com/security-info) 绑定更多的安全信息，避免日后无法访问账号
![](https://raw-posts.2x.nz/img/ms-e3-e4d124d4c11d25813b40a984b6c15465.webp)
