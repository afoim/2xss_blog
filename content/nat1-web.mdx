...
draft: false
coverImage: https://raw-posts.2x.nz/img/nat1-web-0aa77bad-482a-4b65-9a19-4f35acb570ba.webp
---
...
![](https://raw-posts.2x.nz/img/nat1-web-7c517b72-8287-4707-8dff-12690a71d592.webp)
...
![](https://raw-posts.2x.nz/img/nat1-web-890468f0-7e7f-42b9-ba57-f98e3b964626.webp)

#### 创建基底Cloudflare动态重定向规则

如图填写，替换为你的域名
![](https://raw-posts.2x.nz/img/nat1-web-9c4a1cb0-d1c6-4e9b-b2bb-dfd6b6fe6306.webp)

表达式： `wildcard_replace(http.request.full_uri, "*://*.072103.xyz/*", "https://$&#123;2&#125;.stun.072103.xyz:6666/$&#123;3&#125;")`

观察网址，记录下如下图的数据

![](https://raw-posts.2x.nz/img/nat1-web-bdd05652-4676-418f-b8aa-1dfc5b3dfab1.webp)

打开开发者工具后，再保存，确保抓到这样的包，保存备用
![](https://raw-posts.2x.nz/img/nat1-web-60e191a3-c4d8-40a2-b9b7-13af0fae38ab.webp)

将 `dash.cloudflare.com/api` 改为 `api.cloudflare.com/client` 。将刚才获得的红框内的内容填写到 `rules` 后面

![](https://raw-posts.2x.nz/img/nat1-web-b1a7a07c-7b4b-49ff-a152-938e30d93ee6.webp)
...
![](https://raw-posts.2x.nz/img/nat1-web-72dd5daa-a10f-4fa1-816f-8be18abc2587.webp)

#### 配置Lucky DDNS

![](https://raw-posts.2x.nz/img/nat1-web-bf6eafd3-3f7b-4a71-8c4f-c0bd34703eee.webp)

#### 配置Lucky SSL/TLS证书

![](https://raw-posts.2x.nz/img/nat1-web-80fc1bda-334d-4444-b063-2d3202de8296.webp)

#### 配置Lucky Web服务

![](https://raw-posts.2x.nz/img/nat1-web-8f64210e-2bb3-4014-96e7-3af577a722f0.webp)

#### 配置Lucky STUN

注：我这里使用了路由器的端口转发，将Lucky的16666（Web服务）端口转发到了路由器的17777端口。如果你不会端口转发，请**不要启用** `不使用Lucky内置端口转发` 并且**目标端口**填写16666

![](https://raw-posts.2x.nz/img/nat1-web-88f5e404-271b-4d20-98c7-b7f39a9247b2.webp)

#### 配置WebHook

如图配置

![](https://raw-posts.2x.nz/img/nat1-web-559bce4c-ed44-4523-a623-7058ef1082dc.webp)
