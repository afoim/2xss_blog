...
draft: false
coverImage: https://raw-posts.2x.nz/img/hook-steam-drm-hook-steam-drm.webp
---
...
![](https://raw-posts.2x.nz/img/hook-steam-drm-hook-steam-drm-3.webp)

使用 **记事本** 挨个打开，知道找到你需要Hook的游戏，记录以下信息

![](https://raw-posts.2x.nz/img/hook-steam-drm-hook-steam-drm-4.webp)

前往 [Wu-Yijun/steam_client_loader](https://github.com/Wu-Yijun/steam_client_loader)

下载最新的文件名带有 **Windows** 的 **Release**
![](https://raw-posts.2x.nz/img/hook-steam-drm-hook-steam-drm-1.webp)

解压，剔除无关文件

![](https://raw-posts.2x.nz/img/hook-steam-drm-hook-steam-drm-2.webp)
...
![](https://raw-posts.2x.nz/img/hook-steam-drm-hook-steam-drm-5.webp)

随后运行， `steamclient_loader.exe` 即可在不启动Steam的情况下直接拉起游戏

![](https://raw-posts.2x.nz/img/hook-steam-drm-VMWSQyHhF5.gif)
