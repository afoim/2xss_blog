...
draft: false
coverImage: https://raw-posts.2x.nz/img/qqbot-QmcMSSKysZmgUCUk9W7hQUvZCtVSFH6hGKHctg99yo1yDE.webp
---
...
5. 直接进入，如图配置即可（端口号可以自己修改，但是要和下部分NoneBot2监听的端口一致。这里是9090）![](https://raw-posts.2x.nz/img/qqbot-2024-11-20-19-21-21-2024-11-20-19-15-39-image.webp)
