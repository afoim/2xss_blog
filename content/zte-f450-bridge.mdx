...
draft: false
coverImage: https://raw-posts.2x.nz/img/zte-f450-bridge-zte-f450-bridge-4.webp
---
## 基本原理
...
![](https://raw-posts.2x.nz/img/zte-f450-bridge-zte-f450-bridge.webp)

![](https://raw-posts.2x.nz/img/zte-f450-bridge-zte-f450-bridge-1.webp)

解压并使用 `RouterPassView` 打开 `db_user_cfg.xml` 

搜索 `tele` ，寻找超密

![](https://raw-posts.2x.nz/img/zte-f450-bridge-zte-f450-bridge-3.webp)
