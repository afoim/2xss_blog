...
draft: false
coverImage: https://raw-posts.2x.nz/img/whois-16ab7a68-892e-429e-a0bc-02d829eead82.webp
---
## 前言
...
![](https://raw-posts.2x.nz/img/whois-578a2c58-5ad4-452a-be8b-a186a64fa058.webp)
...
![](https://raw-posts.2x.nz/img/whois-d198a5cf-37e0-410e-9f9b-df736725eb7b.webp)

可以看到，成功查询到了 `baidu.com` 的Whois信息。但是实际上这个命令的输出有这么长

![](https://raw-posts.2x.nz/img/whois-3efb10bd-042a-4a22-82c9-e947d591e10d.webp)
...
![](https://raw-posts.2x.nz/img/whois-981f3e74-4e18-47e9-8e05-05ffca461e3c.webp)

更有甚者不仅改格式，甚至还改术语，比如Status写一个Connect

![](https://raw-posts.2x.nz/img/whois-29f6f17b-a885-406d-ad70-45e3aacc95d9.webp)
...
![](https://raw-posts.2x.nz/img/whois-7d92115f-f897-427a-b0a6-46d386019443.webp)

乍一看好多无用信息啊，但是你先别急，既然它返回的是JSON，而且所有域名都是一个规范，那么我们完全可以方便快捷的过滤

![](https://raw-posts.2x.nz/img/whois-96760408-d94e-4ddb-854f-8e817a01fd8d.webp)
...
![](https://raw-posts.2x.nz/img/whois-efa46528-43b5-45fb-88e6-5401dfade480.webp)
...
![](https://raw-posts.2x.nz/img/whois-16ab7a68-892e-429e-a0bc-02d829eead82.webp)

而对于**已经支持RDAP查询的顶级域**，直接返回Web URL，让用户自行阅览，如下图

![](https://raw-posts.2x.nz/img/whois-9b4916ef-d096-4954-a87c-abfc88c77d00.webp)

另外，针对于**仅支持RDAP查询的顶级域**，我们需要先通过IANA查询该顶级域的RDAP服务器（实际上传统Whois也需要，但是Linux的Whois包硬编码的Whois查询服务器目前够用 :）

比如我要查询 `freebird.day` ，就需要先前往[.day Domain Delegation Data](https://www.iana.org/domains/root/db/day.html)查找![](https://raw-posts.2x.nz/img/whois-7c7cb4ed-6b1a-4541-b176-ecc5783a3853.webp)

接下来通过给定的RDAP服务器查询即可![](https://raw-posts.2x.nz/img/whois-3d8df636-39e5-48f7-a6c7-9490f373497e.webp)
