...
draft: false
coverImage: https://raw-posts.2x.nz/img/warden-worker-warden-worker.webp
---
## 原理
...
![](https://raw-posts.2x.nz/img/warden-worker-warden-worker-25.webp)

替换 **wrangler.jsonc** 的数据库ID

![](https://raw-posts.2x.nz/img/warden-worker-warden-worker-26.webp)
...
![](https://raw-posts.2x.nz/img/warden-worker-warden-worker-27.webp)
...
![](https://raw-posts.2x.nz/img/warden-worker-warden-worker-29.webp)
...
![](https://raw-posts.2x.nz/img/warden-worker-warden-worker-30.webp)
...
![](https://raw-posts.2x.nz/img/warden-worker-warden-worker-31.webp)

前往控制台绑定域名（若路由需要手动写一条解析到Cloudflare）

![](https://raw-posts.2x.nz/img/warden-worker-warden-worker-28.webp)
...
![](https://raw-posts.2x.nz/img/warden-worker-warden-worker-32.webp)
...
![](https://raw-posts.2x.nz/img/warden-worker-warden-worker-33.webp)
