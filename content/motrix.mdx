...
draft: false
coverImage: https://raw-posts.2x.nz/img/motrix-ee0efba8-8c27-449f-86d0-3e9367d12463.webp
---
...
![](https://raw-posts.2x.nz/img/motrix-6a10d31c-0c39-456c-8402-ff3190a80dcc.webp)

## 配置 Motrix

打开 Motrix，进入 `进阶设置 -> RPC`。你会看到 RPC 监听端口（默认为 `16800`）和一个随机生成的 RPC 授权密钥。
![](https://raw-posts.2x.nz/img/motrix-53e255cf-965f-441d-a47a-81e20f272256.webp)
...
![](https://raw-posts.2x.nz/img/motrix-0f4a510b-378a-45ab-a35f-88cfa53593e3.webp)

最后，右键扩展并勾选“下载拦截”，然后再尝试下载文件。如果配置无误，浏览器中的下载请求会被 Aria2 Explorer 捕获并转发给 Motrix。此时你可以在 **Aria2 Explorer** 和 **Motrix** 中看到正在下载的文件。

![](https://raw-posts.2x.nz/img/motrix-57fa7b18-541e-4115-a160-cd742735e298.webp)
