...
draft: false
coverImage: https://raw-posts.2x.nz/img/asf-QmPEHve8DdVZdwxAZ26BPgbc6cDCBaKC76VVijqVoMBY2k.webp
---
## 可用的目标作业系统
...
![image](https://raw-posts.2x.nz/img/asf-QmcoF7K5sTkd4CRGTZPmnLwheAHpSf68RkZTd4ZST41uXc.webp)

如果你配置了Steam手机验证器，此时应该会弹出登录请求，允许它。然后前往终端界面输入 **Y** 并回车
此时终端应该输出：**成功以 XXXXXXXXXX 的身份登录。**

![image](https://raw-posts.2x.nz/img/asf-QmcuktSJjWFmufsLmrYRsbLa9ns7pvRXKWZ5EUyirasKt6.webp)
