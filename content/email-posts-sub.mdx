...
draft: false
tags: []
coverImage: https://raw-posts.2x.nz/img/email-posts-sub-email.png
---
## 视频
...
- **简易瞪眼法** 在多次浏览中，若文章状态变化，右下角的小铃铛则会显示相应通知，点击后甚至可以看到高级的DIFF
	![](https://raw-posts.2x.nz/img/email-posts-sub-email-posts-sub.png)
- **RSS** 通过RSS订阅器订阅本博客的RSS XML文件，由第三方告知文章更新状态
	![](https://raw-posts.2x.nz/img/email-posts-sub-email-posts-sub-1.png)
- **加入群组** 通过置顶文章加入群组，群内会有Bot在文章更新时广播一条消息
	![](https://raw-posts.2x.nz/img/email-posts-sub-email-posts-sub-2.png)
...
![](https://raw-posts.2x.nz/img/email-posts-sub-c9bb51ef1f6e3c994f76c55ae7854fb5.png)

![](https://raw-posts.2x.nz/img/email-posts-sub-email-posts-sub-3.png)

![](https://raw-posts.2x.nz/img/email-posts-sub-a570d8792d2823cabbe41834d0a64405.png)
