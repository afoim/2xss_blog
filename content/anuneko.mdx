...
draft: false
coverImage: https://raw-posts.2x.nz/img/anuneko-anuneko.webp
---
## 这是What
这是橘猫，会哈气（见封面
...
![](https://raw-posts.2x.nz/img/anuneko-anuneko-1.webp)
...
通了
![](https://raw-posts.2x.nz/img/anuneko-anuneko-2.webp)

然后还有一种情况，在遇到Pick的时候，我们要发送要选择的回复编号
![](https://raw-posts.2x.nz/img/anuneko-anuneko-3.webp)
