...
draft: false
tags: []
coverImage: https://raw-posts.2x.nz/img/astro-to-svelte-svelte.png
---
## 为什么要重构为纯Svelte？
...
![](https://raw-posts.2x.nz/img/astro-to-svelte-index.png)

放眼望去，第一个感觉就是大。相比于传统的博客站，Fuwari的设计语言明显是更现代，更灵动的，因为Fuwari还采用了Swup来做SPA页切，这使得网站从一开始的进入，再到用户主动切换页面，都是非常丝滑流畅的

![](https://raw-posts.2x.nz/img/astro-to-svelte-msedge_j3Hr8CjoVV.gif)
...
![](https://raw-posts.2x.nz/img/astro-to-svelte-index-1.png)

那么在博客上扔一个 **论坛** 则是一个完全改变项目定位的做法，Astro SSG并不擅长处理全栈，所以便使用了 `@astrojs/svelte` 来实现这种重客户端交互的页面

![](https://raw-posts.2x.nz/img/astro-to-svelte-index-2.png)
...
![](https://raw-posts.2x.nz/img/astro-to-svelte-Pasted-image-20260424182832.png)
...
![](https://raw-posts.2x.nz/img/astro-to-svelte-index-5.png)
...
![](https://raw-posts.2x.nz/img/astro-to-svelte-index-3.png)

而这些功能无一例外都是 **Svelte** 。这更代表了整个项目已经被 Svelte 架空了，那么，不如贯彻到底，直接把Astro丢了吧？

![](https://raw-posts.2x.nz/img/astro-to-svelte-index-4.png)
...
![](https://raw-posts.2x.nz/img/astro-to-svelte-index-11.png)
...
![](https://raw-posts.2x.nz/img/astro-to-svelte-index-7.png)

而新站，开启增量图片压缩后也仅需1分钟左右

![](https://raw-posts.2x.nz/img/astro-to-svelte-index-8.png)

再接下来，是重定向。由于SvelteKit并不像Astro一样支持直接在类似 `astro.config.mjs` 里配置静态重定向

![](https://raw-posts.2x.nz/img/astro-to-svelte-index-9.png)

不过这也是个好处，我们可以自己写一个Vite插件来创建静态重定向，并自定义重定向页面

![](https://raw-posts.2x.nz/img/astro-to-svelte-index-10.png)
...
![](https://raw-posts.2x.nz/img/astro-to-svelte-index-12.png)
