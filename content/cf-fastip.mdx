...
draft: false
coverImage: https://raw-posts.2x.nz/img/cf-fastip-cf-fastip-11.webp
---
## 相关视频：
- **全解**： [https://www.bilibili.com/video/BV1QpSoBqERj](https://www.bilibili.com/video/BV1QpSoBqERj)
- ~~SaaS原理：[https://www.bilibili.com/video/BV1A5rpBqENh/](https://www.bilibili.com/video/BV1A5rpBqENh/)~~
- ~~Worker/Pages优选：[https://www.bilibili.com/video/BV1KNmtB6EU7/](https://www.bilibili.com/video/BV1KNmtB6EU7/)~~
- ~~R2优选：[https://www.bilibili.com/video/BV115KLzSEiv/](https://www.bilibili.com/video/BV115KLzSEiv/)~~
- ~~Tunnel优选：[https://www.bilibili.com/video/BV1WGMAznEBd/](https://www.bilibili.com/video/BV1WGMAznEBd/)~~
- ~~自建优选：[https://www.bilibili.com/video/BV1H38vzoEcq/](https://www.bilibili.com/video/BV1H38vzoEcq/)
  [https://www.bilibili.com/video/BV1zpgBz7EHK/](https://www.bilibili.com/video/BV1zpgBz7EHK/)~~

> [!tip]
> 所有优选一个域名即可，无需两个域名。如： `s.2x.nz` 和 `s-s.2x.nz` 即可完成优选
##### 未优选

![QmZoinxZgAzu7Skh7BqsxmDQGU1sXtLLskJcyQuRAQNKww.webp](https://raw-posts.2x.nz/img/cf-fastip-098f9ee71ae62603022e542878673e19bdcaf196.webp)

##### 已优选

![](https://raw-posts.2x.nz/img/cf-fastip-cf-fastip-11.webp)
...
![](https://raw-posts.2x.nz/img/cf-fastip-838f685e-3913-4b21-995e-5ee149f4bffa.webp)
...
![](https://raw-posts.2x.nz/img/cf-fastip-cf-fastip.png)

最后写一条DNS解析到想要的优选域名，完事！

![](https://raw-posts.2x.nz/img/cf-fastip-cf-fastip-1.png)
...
![](https://raw-posts.2x.nz/img/cf-fastip-56752d54-26a5-46f1-a7d9-a782ad9874cb.webp)

类似这样填写：

![](https://raw-posts.2x.nz/img/cf-fastip-d025398c-39e3-4bd7-8d8f-2ce06a45007d.webp)
...
![](https://raw-posts.2x.nz/img/cf-fastip-cf-fastip-4.png)

接着，你需要绑定一个自定义域

![](https://raw-posts.2x.nz/img/cf-fastip-cf-fastip-5.png)

接着，前往你的域名 - 规则 - Cloud Connector

![](https://raw-posts.2x.nz/img/cf-fastip-cf-fastip-6.png)

![](https://raw-posts.2x.nz/img/cf-fastip-cf-fastip-7.png)

![](https://raw-posts.2x.nz/img/cf-fastip-cf-fastip-8.png)
...
![](https://raw-posts.2x.nz/img/cf-fastip-cf-saas-1.webp)

![](https://raw-posts.2x.nz/img/cf-fastip-cf-saas-2.webp)

![](https://raw-posts.2x.nz/img/cf-fastip-cf-saas-3.webp)

Worker中的路由规则也适用：

![](https://raw-posts.2x.nz/img/cf-fastip-cf-saas-4.webp)
...
> ![](https://raw-posts.2x.nz/img/cf-fastip-cf-fastip-1.webp)
...
![](https://raw-posts.2x.nz/img/cf-fastip-cf-fastip.webp)

##### 具体步骤

1. 首先新建一个DNS解析，指向你的**源站**，**开启cf代理**
   ![QmfBKgDe77SpkUpjGdmsxqwU2UabvrDAw4c3bgFiWkZCna.webp](https://raw-posts.2x.nz/img/cf-fastip-c94c34ee262fb51fb5697226ae0df2d804bf76fe.webp)
...
3. 点击添加自定义主机名。设置一个自定义主机名，比如 `onani.cn`，然后选择**自定义源服务器**，填写第一步的域名，即 `xlog.acofork.cn`。
   ...
   ![QmRYrwjeDMDQCj8G9RYkpjC3X4vpwE77wpNpbqKURwBber.webp](https://raw-posts.2x.nz/img/cf-fastip-f6170f009c43f7c6bee4c2d29e2db7498fa1d0dc.webp)

4. 继续在你的辅助域名添加一条解析。CNAME到优选节点：如cloudflare.182682.xyz，**不开启cf代理**
   ![QmNwkMqDEkCGMu5jsgE6fj6qpupiqMrqqQtWeAmAJNJbC4.webp](https://raw-posts.2x.nz/img/cf-fastip-4f9f727b0490e0b33d360a2363c1026003060b29.webp)

5. 最后在你的主力域名添加解析。域名为之前在辅助域名的自定义主机名（onani.cn），目标为刚才的cdn.acofork.cn，**不开启cf代理**
   ![QmeK3AZghae4J4LcJdbPMxBcmoNEeF3hXNBmtJaDki8HYt.webp](https://raw-posts.2x.nz/img/cf-fastip-6f51cb2a42140a9bf364f88a5715291be616a254.webp)

6. 优选完毕，确保优选有效后尝试访问
   ![](https://raw-posts.2x.nz/img/cf-fastip-cf-fastip-10.webp)
...
2. 如果是外域，SaaS后再添加路由即可，就像：
   ![](https://raw-posts.2x.nz/img/cf-fastip-cf-fastip-12.webp)

   ![](https://raw-posts.2x.nz/img/cf-fastip-cf-fastip-13.webp)

## 针对于Cloudflare Tunnel（ZeroTrust）

请先参照 [传统SaaS优选](#传统saas优选) 设置完毕，源站即为 Cloudflare Tunnel。正常做完SaaS接入即可：

![](https://raw-posts.2x.nz/img/cf-fastip-cf-fastip-3.webp)

![](https://raw-posts.2x.nz/img/cf-fastip-cf-fastip-2.webp)
...
![](https://raw-posts.2x.nz/img/cf-fastip-cf-fastip-3.png)
