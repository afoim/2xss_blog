...
draft: false
tags: []
coverImage: https://raw-posts.2x.nz/img/improve-dev-speed-astro.png
---
## 引言
...
![423](https://raw-posts.2x.nz/img/improve-dev-speed-improve-dev-speed-6.png)
...
![](https://raw-posts.2x.nz/img/improve-dev-speed-improve-dev-speed-7.png)

最终，开发服务器的启动快如闪电！**仅需7秒** 

![](https://raw-posts.2x.nz/img/improve-dev-speed-Kiro_NcMc9NkpG3.gif)

而之前...这也太慢了... **近乎1分钟** 

![](https://raw-posts.2x.nz/img/improve-dev-speed-Kiro_tYIjKYtTlP.gif)
