...
draft: false
coverImage: https://raw-posts.2x.nz/img/onedrive-index-onedrive-index.webp
---
...
![](https://raw-posts.2x.nz/img/onedrive-index-onedrive-index-1.webp)

填写必须的5个环境变量
![](https://raw-posts.2x.nz/img/onedrive-index-onedrive-index-2.webp)
...
![](https://raw-posts.2x.nz/img/onedrive-index-onedrive-index-3.webp)

前往 https://vercel.com/integrations/upstash 点击 Install
![](https://raw-posts.2x.nz/img/onedrive-index-onedrive-index-4.webp)

选择你要绑定的Vercel项目，并且设置Redis实例名称
![](https://raw-posts.2x.nz/img/onedrive-index-onedrive-index-5.webp)

来到Vercel的环境变量页面，这就是绑定成功了
![](https://raw-posts.2x.nz/img/onedrive-index-onedrive-index-6.webp)
...
成功部署！
![](https://raw-posts.2x.nz/img/onedrive-index-onedrive-index-7.webp)

## 同项目更改OneDrive账号
首先在Vercel上更改这三个环境变量
![](https://raw-posts.2x.nz/img/onedrive-index-onedrive-index-8.webp)

然后打开 Upstash 找到对应的Redis，删除里面存储的所有Token
![](https://raw-posts.2x.nz/img/onedrive-index-onedrive-index-9.webp)
