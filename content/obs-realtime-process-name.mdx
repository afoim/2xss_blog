...
draft: false
tags: []
coverImage: https://raw-posts.2x.nz/img/obs-realtime-process-name-OBS-RT-PC.png
---
## 引言
...
![](https://raw-posts.2x.nz/img/obs-realtime-process-name-obs-realtime-process-name.png)

这个思路完全可行。实测下来，OBS 会每隔几秒重新读取一次 TXT 内容。虽然它不是即时 Hook，而是简单轮询，但对于“当前正在使用什么软件”这类信息来说，已经完全够用了。

![](https://raw-posts.2x.nz/img/obs-realtime-process-name-obs64_ZV5MPVYEXj.gif)
...
![](https://raw-posts.2x.nz/img/obs-realtime-process-name-obs-realtime-process-name-2.png)
...
![](https://raw-posts.2x.nz/img/obs-realtime-process-name-WindowsTerminal_wV1C4TbD15.gif)

![](https://raw-posts.2x.nz/img/obs-realtime-process-name-livehime_vtq9relmFS.gif)
