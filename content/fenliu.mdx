...
draft: false
tags: []
coverImage: https://raw-posts.2x.nz/img/fenliu-fenliu.webp
---
...
![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/fenliu-fenliu-1.webp)
#### ESA
使用DCV委派
![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/fenliu-fenliu-2.webp)
#### Cloudflare
使用HTTP验证，由于ACME验证节点在国外，所以它只会看到CNAME到Cloudflare的记录，从而签发SSL
![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/fenliu-fenliu-3.webp)
针对重定向的域名，由于默认所有请求都会被重定向到新域，ACME自然无法验证，所以我们需要写一条排除规则，让ACME验证路径直接返回200 OK，其余的路径再重定向
![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/fenliu-fenliu-17.webp)
...
![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/fenliu-fenliu-4.webp)

![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/fenliu-fenliu-5.webp)

![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/fenliu-fenliu-16.webp)
#### 动态型

国内使用IPv6回源（用户 - IPv4 - EO/ESA CDN - IPv6 - 源站）。至于为什么不用ESA，是因为ESA CDN回源非标端口需要像Cloudflare一样写一条回源规则，占用免费规则集5条中的其中之一
![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/fenliu-fenliu-6.webp)
海外采用Cloudflare Tunnel（用户 - IPv4 - CF CDN - 内部连接 - 源站）
![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/fenliu-fenliu-7.webp)

## 浏览器客户端实现监看当前访问节点

利用浏览器JavaScript发送HEAD请求拿取对端响应头Server字段并回显（若跨域则需要设置 **Access-Control-Expose-Headers** 响应头，值为 **server**
![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/fenliu-fenliu-12.webp)

![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/fenliu-ae6f93ce318fa428e94256c2b4a501e1.webp)
...
![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/fenliu-fenliu-8.webp)
- 如果你要做分流业务，必须将域名NS托管在国内的DNS解析服务商，因为Cloudflare不支持域名分流解析，并且请将默认解析给CF，将境内解析给国内节点，不要反着来
![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/fenliu-fenliu-9.webp)
...
![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/fenliu-fenliu-11.webp)

![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/fenliu-fenliu-10.webp)
...
![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/fenliu-fenliu-13.webp)
...
![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/fenliu-fenliu-14.webp)

![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/fenliu-fenliu-15.webp)
## 成果展示

#### 博客本体

![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/https___blogacoforkcom__多地区多线路HTTP测速(1).webp)
#### Umami
![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/fenliu-https___umamiacoforkcom__多地区多线路HTTP测速.webp)
#### 随机图
![](https://raw-posts.2x.nz/img/fenliu-fenliu.webphttps://raw-posts.2x.nz/img/fenliu-https___picacoforkcom__多地区多线路HTTP测速.webp)
