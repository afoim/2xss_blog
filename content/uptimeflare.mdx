...
draft: false
tags: []
coverImage: https://raw-posts.2x.nz/img/uptimeflare-uptimeflare.webp
---
## 从KV迁移
...
这迁移到D1何意味
![](https://raw-posts.2x.nz/img/uptimeflare-uptimeflare-16.webp)
...
![](https://raw-posts.2x.nz/img/uptimeflare-uptimeflare-1.webp)

![](https://raw-posts.2x.nz/img/uptimeflare-uptimeflare-14.webp)
...
![](https://raw-posts.2x.nz/img/uptimeflare-uptimeflare-4.webp)

最后，来到 `Action` 页面，手动创建一个 `Deploy to Cloudflare` 的工作流
![](https://raw-posts.2x.nz/img/uptimeflare-uptimeflare-5.webp)

等待工作流运行结束，你应该可以在Cloudflare仪表板看见一个新的Page，新的Worker和新的D1
![](https://raw-posts.2x.nz/img/uptimeflare-uptimeflare-6.webp)


点开 Page，注意不要点错了
![](https://raw-posts.2x.nz/img/uptimeflare-uptimeflare-8.webp)

绑定你的域名，尝试访问
![](https://raw-posts.2x.nz/img/uptimeflare-uptimeflare-9.webp)

如果你能看到一个初始的监控页面，则正常
![](https://raw-posts.2x.nz/img/uptimeflare-uptimeflare-10.webp)
...
添加一个域名（作为你的发信域名）
![](https://raw-posts.2x.nz/img/uptimeflare-uptimeflare-11.webp)

创建一个发信API Key
![](https://raw-posts.2x.nz/img/uptimeflare-uptimeflare-12.webp)

添加环境变量： `RESEND_API_KEY` 将其绑定到 **Action**

![](https://raw-posts.2x.nz/img/uptimeflare-uptimeflare-13.webp)
...
![](https://raw-posts.2x.nz/img/uptimeflare-1dc1a98a404db83e909c1f87e8a115cf.webp)
