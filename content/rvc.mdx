...
draft: false
coverImage: https://raw-posts.2x.nz/img/rvc-rvc-19.webp
---
...
![](https://raw-posts.2x.nz/img/rvc-rvc-1.webp)

直接运行 `go-web.bat`

![](https://raw-posts.2x.nz/img/rvc-rvc-2.webp)

进入 WebUI 并切换到训练一栏

![](https://raw-posts.2x.nz/img/rvc-rvc-3.webp)

首先写模型名称

![](https://raw-posts.2x.nz/img/rvc-rvc-4.webp)

然后将你的音源放到一个空文件夹

![](https://raw-posts.2x.nz/img/rvc-rvc-5.webp)

然后填进去

![](https://raw-posts.2x.nz/img/rvc-rvc-6.webp)

总训练轮数推荐50 ~ 200

![](https://raw-posts.2x.nz/img/rvc-rvc-7.webp)

然后点击一键训练（需要很久，建议晚上睡觉前训练）

![](https://raw-posts.2x.nz/img/rvc-rvc-8.webp)

训练结束后可以在 `assets/weights` 找到模型文件， `.pth` 结尾的

![](https://raw-posts.2x.nz/img/rvc-rvc-9.webp)
...
![](https://raw-posts.2x.nz/img/rvc-rvc-10.webp)

在输出的文件的 **View in Folder** 可以找到 **干净的AI人声** 

![](https://raw-posts.2x.nz/img/rvc-rvc-11.webp)
...
![](https://raw-posts.2x.nz/img/rvc-rvc-12.webp)
选择 **Download Center** 下载 **VR  Arch** 的 **5_HP-Karaoke-UVR** 模型。然后回到首页
![](https://raw-posts.2x.nz/img/rvc-rvc-13.webp)
...
![](https://raw-posts.2x.nz/img/rvc-rvc-14.webp)

输出文件夹中 **Instrumental** 为伴奏， **Vocals** 为人声

![](https://raw-posts.2x.nz/img/rvc-rvc-15.webp)
...
![](https://raw-posts.2x.nz/img/rvc-rvc-16.webp)

首先去安装模型。每个模型的最终输出文件可能不一样

![](https://raw-posts.2x.nz/img/rvc-rvc-17.webp)

然后都是字面意思了，随后点击 **输入音频分离** 开始转换

![](https://raw-posts.2x.nz/img/rvc-rvc-18.webp)
