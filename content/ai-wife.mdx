...
coverImage: https://raw-posts.2x.nz/img/ai-wife-index.png
date: "2026-04-26"
draft: false
pin: false
---
...
![2025-05-13-11-59-50-ComfyUI_00016_.webp](https://raw-posts.2x.nz/img/ai-wife-2025-05-13-11-59-50-ComfyUI_00016_.webp)

![2025-05-13-12-00-37-ComfyUI_00011_.webp](https://raw-posts.2x.nz/img/ai-wife-2025-05-13-12-00-37-ComfyUI_00011_.webp)
...
![](https://raw-posts.2x.nz/img/ai-wife-ai-wife.png)

点击右下角的开始运行，先让他进行初始化，直到它自动打开你的浏览器并且可以正常进入ComfyUI的界面

![2025-05-13-12-06-57-image.webp](https://raw-posts.2x.nz/img/ai-wife-2025-05-13-12-06-57-image.webp)
...
![](https://raw-posts.2x.nz/img/ai-wife-index-1.png)
...
![](https://raw-posts.2x.nz/img/ai-wife-ai-wife-1.png)

在详情页你可以看到该LoRA所需要的基底模型。有些时候模型的简介也会写

下面的 **Trigger Words** 是推荐的 **正向提示词** 一般来说仅导入LoRA不写专有提示词也会有一定的效果

![](https://raw-posts.2x.nz/img/ai-wife-ai-wife-2.png)
...
![](https://raw-posts.2x.nz/img/ai-wife-Pasted-image-20260426144044.png)
...
![](https://raw-posts.2x.nz/img/ai-wife-ai-wife-3.png)

接下来，你应该已经有了这些节点

![](https://raw-posts.2x.nz/img/ai-wife-ai-wife-4.png)

#### 加载模型

这里加载基底模型，刷新ComfyUI后你应该可以在 `Checkpoint加载器(简易)` 处看到你放置的所有模型，选择带有 `vPred...` 的就是V预测模型

![2025-05-13-12-11-55-image.webp](https://raw-posts.2x.nz/img/ai-wife-2025-05-13-12-11-55-image.webp)

![](https://raw-posts.2x.nz/img/ai-wife-ai-wife-5.png)

这里加载LoRA（如果有）

![](https://raw-posts.2x.nz/img/ai-wife-ai-wife-6.png)

#### 填写提示词

这里填写正/反向提示词，均为 **英文** ，如果不会写就去找其他AI描述你要画什么，然后让它返回给你用以AI绘图的prompt

![](https://raw-posts.2x.nz/img/ai-wife-ai-wife-7.png)
...
![2025-05-13-12-15-16-image.webp](https://raw-posts.2x.nz/img/ai-wife-2025-05-13-12-15-16-image.webp)

复制 `Prompt tags`，然后将其粘贴进链接了正面条件的CLIP文本编码器

![2025-05-13-12-16-35-image.webp](https://raw-posts.2x.nz/img/ai-wife-2025-05-13-12-16-35-image.webp)
...
![2025-05-13-12-19-32-image.webp](https://raw-posts.2x.nz/img/ai-wife-2025-05-13-12-19-32-image.webp)
...
![2025-05-13-12-22-06-image.webp](https://raw-posts.2x.nz/img/ai-wife-2025-05-13-12-22-06-image.webp)

![](https://raw-posts.2x.nz/img/ai-wife-ai-wife-8.png)
...
![](https://raw-posts.2x.nz/img/ai-wife-ai-wife-9.png)
...
![](https://raw-posts.2x.nz/img/ai-wife-ai-wife-16.png)

#### 运行生成

接下来点击右上角的运行，哦对了，你还可以编辑旁边的数字来一次性生成多张图片

![](https://raw-posts.2x.nz/img/ai-wife-ai-wife-10.png)

由于我们开启了实时预览，你可以看到模型每一步的绘画进度

![](https://raw-posts.2x.nz/img/ai-wife-ComfyUI_UkQQZG4KkW.gif)

点击右上角的资产，可以展开，查看大图

![](https://raw-posts.2x.nz/img/ai-wife-ai-wife-11.png)

所有生成的图片都可以在 `output` 文件夹看到

![](https://raw-posts.2x.nz/img/ai-wife-ai-wife-12.png)

如果你想画其他角色也只需要：**找LoRA，写推荐提示词，开跑！**

![](https://raw-posts.2x.nz/img/ai-wife-ai-wife-13.png)

![](https://raw-posts.2x.nz/img/ai-wife-ai-wife-14.png)
...
![2025-05-13-12-30-55-image.webp](https://raw-posts.2x.nz/img/ai-wife-2025-05-13-12-30-55-image.webp)
...
![](https://raw-posts.2x.nz/img/ai-wife-Screenshot_2026-04-26-14-53-03-67.jpg)
...
![](https://raw-posts.2x.nz/img/ai-wife-index-2.png)

搜索（用英文）并选择一个你想跑的角色，复制角色tag

![](https://raw-posts.2x.nz/img/ai-wife-index-3.png)

填入正向提示词

![](https://raw-posts.2x.nz/img/ai-wife-index-4.png)

DanBooru的角色有非常多，所以在大多数情况下，我们不需要引入特定角色的Lora即可出图

![](https://raw-posts.2x.nz/img/ai-wife-index-15.png)

![](https://raw-posts.2x.nz/img/ai-wife-index-5.png)

##### 使用角色Lora

直接选择你想跑的角色的工作流，正向提示词会自动添加，直接生图即可

![](https://raw-posts.2x.nz/img/ai-wife-index-6.png)

![](https://raw-posts.2x.nz/img/ai-wife-index-8.png)

##### 自定义绘画

你可以使用 **英文Tag** 来控制图像生成，如在正向提示词添加 `school` ，则最终出图会有 **学校元素** （图例为校服）

![](https://raw-posts.2x.nz/img/ai-wife-index-7.png)

![](https://raw-posts.2x.nz/img/ai-wife-index-9.png)
...
![](https://raw-posts.2x.nz/img/ai-wife-msedge_hAkxNR1yEH.gif)

![](https://raw-posts.2x.nz/img/ai-wife-index-11.png)
...
![](https://raw-posts.2x.nz/img/ai-wife-index-12.png)

![](https://raw-posts.2x.nz/img/ai-wife-index-13.png)
...
![](https://raw-posts.2x.nz/img/ai-wife-index-17.png)
![](https://raw-posts.2x.nz/img/ai-wife-index-14.png)
