...
draft: false
tags: []
coverImage: https://raw-posts.2x.nz/img/fuck-mswin11-rdp-fkms.png
---
## 症状

一个带有远程桌面的版本（非家庭版），最新版Win11（25h2），启用了远程桌面服务

![](https://raw-posts.2x.nz/img/fuck-mswin11-rdp-index.png)

![](https://raw-posts.2x.nz/img/fuck-mswin11-rdp-index-1.png)
...
![](https://raw-posts.2x.nz/img/fuck-mswin11-rdp-index-2.png)
